...
public class ECommerce_StockAvailability extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            if (type.equals("Furniture")) {
                response.sendRedirect("/IS3102_Project-war/B/SG/furnitureProductDetails.jsp?sku=" + SKU + "&itemQty=" + itemQty + "&storeID=" + storeID + "&ind=" + ind + "&category=" + URLEncoder.encode(category));
            } else if (type.equals("Retail Product")) {
                response.sendRedirect("/IS3102_Project-war/B/SG/retailProductDetails.jsp?sku=" + SKU + "&itemQty=" + itemQty + "&storeID=" + storeID + "&ind=" + ind + "&category=" + URLEncoder.encode(category));
            }
